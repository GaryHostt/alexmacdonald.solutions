...
### Autonomous Database
  ...
  - **The Manufacturing Maintenance Office**, an APEX application inspired by my time at DuPont
      ...
      - go to [apex.alexmacdonald.solutions](http://apex.alexmacdonald.solutions), login and go to [dashboard on the left menu](tip "you can look like you're busy by leaving it on your second monitor")
